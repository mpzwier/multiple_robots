...
constexpr auto DEFAULT_TRANSFORM_TOPIC = "tf_dummy";
}  // namespace
...
DifferentialDriveController::DifferentialDriveController() : controller_interface::ChainableControllerInterface() {}
...
controller_interface::return_type DifferentialDriveController::update_reference_from_subscribers(
...
controller_interface::return_type DifferentialDriveController::update_and_write_commands(
  const rclcpp::Time & time, const rclcpp::Duration & period)
{
  auto logger = get_node()->get_logger();
...
controller_interface::CallbackReturn DifferentialDriveController::on_configure(
...
controller_interface::CallbackReturn DifferentialDriveController::on_activate(
  const rclcpp_lifecycle::State &)
{
...
controller_interface::CallbackReturn DifferentialDriveController::on_deactivate(
  const rclcpp_lifecycle::State &)
{
...
controller_interface::CallbackReturn DifferentialDriveController::on_cleanup(
  const rclcpp_lifecycle::State &)
{
  if (!reset())
  {
...
controller_interface::CallbackReturn DifferentialDriveController::on_error(const rclcpp_lifecycle::State &)
{
  if (!reset())
  {
    return controller_interface::CallbackReturn::ERROR;
...
void DifferentialDriveController::reset_buffers()
{
  std::fill(
...
bool DifferentialDriveController::on_set_chained_mode(bool /*chained_mode*/) { return true; }

std::vector<hardware_interface::CommandInterface>
DifferentialDriveController::on_export_reference_interfaces()
{
...
CLASS_LOADER_REGISTER_CLASS(
  differential_drive_controller::DifferentialDriveController, controller_interface::ChainableControllerInterface)