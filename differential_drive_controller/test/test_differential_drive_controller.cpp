...
class TestableDifferentialDriveController : public differential_drive_controller::DifferentialDriveController
{
public:
  using DifferentialDriveController::DifferentialDriveController;
  using DifferentialDriveController::odometry_;
  ...
  FRIEND_TEST(TestDifferentialDriveController, configure_succeeds_tf_test_prefix_false_no_namespace);
  FRIEND_TEST(TestDifferentialDriveController, configure_succeeds_tf_test_prefix_true_no_namespace);
  FRIEND_TEST(TestDifferentialDriveController, configure_succeeds_tf_blank_prefix_true_no_namespace);
  FRIEND_TEST(TestDifferentialDriveController, configure_succeeds_tf_test_prefix_false_set_namespace);
  FRIEND_TEST(TestDifferentialDriveController, configure_succeeds_tf_test_prefix_true_set_namespace);
  FRIEND_TEST(TestDifferentialDriveController, configure_succeeds_tf_blank_prefix_true_set_namespace);
  // Declare these tests as friends so we can access controller_->reference_interfaces_
  FRIEND_TEST(TestDifferentialDriveController, chainable_controller_unchained_mode);
  FRIEND_TEST(TestDifferentialDriveController, chainable_controller_chained_mode);
  FRIEND_TEST(TestDifferentialDriveController, deactivate_then_activate);
};

class TestDifferentialDriveController : public ::testing::Test
{
protected:
  void SetUp() override
  {
    ...
    controller_ = std::make_unique<TestableDifferentialDriveController>();
  ...
  std::unique_ptr<TestableDifferentialDriveController> controller_;
...
TEST_F(TestDifferentialDriveController, init_fails_without_parameters)
{
  controller_interface::ControllerInterfaceParams params;
  params.controller_name = controller_name;
  params.robot_description = urdf_;
...
TEST_F(TestDifferentialDriveController, init_fails_with_only_left_or_only_right_side_defined)
{
...
TEST_F(TestDifferentialDriveController, configure_fails_with_mismatching_wheel_side_size)
{
  ASSERT_EQ(
...
TEST_F(
  TestDifferentialDriveController,
...
TEST_F(TestDifferentialDriveController, configure_succeeds_tf_test_prefix_false_no_namespace)
{
...
TEST_F(TestDifferentialDriveController, configure_succeeds_tf_test_prefix_true_no_namespace)
{
  std::string odom_id = "odom";
  std::string base_link_id = "base_link";
  std::string frame_prefix = "test_prefix";
...
TEST_F(TestDifferentialDriveController, configure_succeeds_tf_blank_prefix_true_no_namespace)
{
  std::string odom_id = "odom";
  std::string base_link_id = "base_link";
...
TEST_F(TestDifferentialDriveController, configure_succeeds_tf_test_prefix_false_set_namespace)
{
...
TEST_F(TestDifferentialDriveController, configure_succeeds_tf_test_prefix_true_set_namespace)
{
  std::string test_namespace = "/test_namespace";
...
TEST_F(TestDifferentialDriveController, configure_succeeds_tf_blank_prefix_true_set_namespace)
{
  std::string test_namespace = "/test_namespace";
  std::string odom_id = "odom";
  std::string base_link_id = "base_link";
...
TEST_F(TestDifferentialDriveController, activate_fails_without_resources_assigned)
{
  ASSERT_EQ(InitController(), controller_interface::return_type::OK);
...
TEST_F(TestDifferentialDriveController, activate_succeeds_with_pos_resources_assigned)
{
  ASSERT_EQ(InitController(), controller_interface::return_type::OK);
...
TEST_F(TestDifferentialDriveController, activate_succeeds_with_vel_resources_assigned)
{
  ASSERT_EQ(
    InitController(
      left_wheel_names, right_wheel_names,
...
TEST_F(TestDifferentialDriveController, activate_succeeds_with_open_loop_assigned)
{
  ASSERT_EQ(
    InitController(
      left_wheel_names, right_wheel_names,
...
TEST_F(TestDifferentialDriveController, test_speed_limiter)
{
...
TEST_F(TestDifferentialDriveController, activate_fails_with_wrong_resources_assigned_1)
{
  ASSERT_EQ(
    InitController(
      left_wheel_names, right_wheel_names,
...
TEST_F(TestDifferentialDriveController, activate_fails_with_wrong_resources_assigned_2)
{
  ASSERT_EQ(
    InitController(
      left_wheel_names, right_wheel_names,
...
TEST_F(TestDifferentialDriveController, activate_silently_ignores_with_unnecessary_resources_assigned_1)
{
  ASSERT_EQ(
    InitController(
      left_wheel_names, right_wheel_names,
...
TEST_F(TestDifferentialDriveController, activate_silently_ignores_with_unnecessary_resources_assigned_2)
{
  ASSERT_EQ(
    InitController(
      left_wheel_names, right_wheel_names,
...
TEST_F(TestDifferentialDriveController, cleanup)
{
  ASSERT_EQ(
    InitController(
      left_wheel_names, right_wheel_names,
...
TEST_F(TestDifferentialDriveController, correct_initialization_using_parameters)
{
  ASSERT_EQ(
    InitController(
      left_wheel_names, right_wheel_names,
...
TEST_F(TestDifferentialDriveController, chainable_controller_unchained_mode)
{
  ASSERT_EQ(
    InitController(
      left_wheel_names, right_wheel_names,
...
TEST_F(TestDifferentialDriveController, chainable_controller_chained_mode)
{
  ASSERT_EQ(
    InitController(
      left_wheel_names, right_wheel_names,
...
TEST_F(TestDifferentialDriveController, reference_interfaces_are_properly_exported)
{
  ASSERT_EQ(
...
TEST_F(TestDifferentialDriveController, deactivate_then_activate)
{
  ASSERT_EQ(
    InitController(
      left_wheel_names, right_wheel_names,
...
TEST_F(TestDifferentialDriveController, command_with_zero_timestamp_is_accepted_with_warning)
{
  ASSERT_EQ(
    InitController(
      left_wheel_names, right_wheel_names,
...
TEST_F(TestDifferentialDriveController, test_open_loop_odometry_with_clamped_input)
{
...
TEST_F(TestDifferentialDriveController, test_open_loop_odometry_with_unclamped_input)
{
